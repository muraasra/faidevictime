...
export const generalQuestions = [
  { key: 'nom_structure', label: 'Nom de la structure', type: 'text' },
  { key: 'fonction_repondant', label: 'Fonction du répondant', type: 'text' },
  { key: 'nom_repondant', label: 'Nom du répondant', type: 'text' },
  { key: 'telephone_repondant', label: 'Téléphone du répondant', type: 'text' },
  ...
  { key: 'heures_ouverture', label: 'Heure d\'ouverture', type: 'time' },
  { 
    key: 'gratuit',
