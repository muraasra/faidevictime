  ...
  <div class="min-h-screen bg-gray-100 flex">
      ...
      <div class="flex-1 overflow-y-auto p-4">
        ...
        <div class="space-y-3">
          ...
          >
            ...
            <div v-if="currentConversationId === conv.id" class="flex items-center mt-2">
              <div class="w-2 h-2 bg-green-500 rounded-full mr-2 animate-pulse"></div>
              <span class="text-xs text-green-600 font-medium">Conversation Active</span>
            </div>
          </div>
        </div>
      </div>
    ...
    >
      ...
      <div class="relative w-80 bg-white shadow-xl max-w-[85vw] flex flex-col">
        ...
        <div class="flex-1 overflow-y-auto p-4">
            <button 
              @click="() => { startNewChat(); showMobileMenu= !showMobileMenu; }" 
    ...
    <div class="flex-1 flex flex-col bg-white h-screen">
      <!-- En-tête du Chat -->
      <div class="bg-white border-b border-gray-200 px-4 md:px-6 py-4 shadow-sm flex-shrink-0">
        <div class="flex items-center justify-between">
          <div class="ml-16 md:ml-0">
            ...
            <p class="text-sm text-gray-500 mt-1">
              {{ currentConversationId ? `${messages.length} messages dans cette conversation` : 'Commencez une nouvelle conversation' }}
            </p>
          </div>
          <div v-if="currentConversationId" class="flex items-center bg-green-100 px-3 py-1 rounded-full">
            <div class="w-2 h-2 bg-green-500 rounded-full mr-2 animate-pulse"></div>
      ...
      <div 
        ...
        class="flex-1 overflow-y-auto p-4 md:p-6 bg-gray-50"
        @scroll="handleScroll"
      >
        ...
        <div v-if="messages.length === 0" class="flex items-center justify-center h-full min-h-[300px]">
          <div class="text-center py-8 md:py-16">
            <div class="max-w-md mx-auto">
              ...
              <h3 class="text-xl md:text-2xl font-semibold text-gray-800 mb-3">Bonjour ! 👋</h3>
              ...
              <div class="mt-6">
                <button 
                  ...
                  class="bg-green-600 hover:bg-green-700 text-white px-6 py-3 rounded-lg transition-all duration-200 shadow-md hover:shadow-lg text-sm md:text-base"
                >
        ...
        <div v-else class="space-y-4 md:space-y-6">
          ...
          >
            ...
            <div 
              ...
              class="flex items-start space-x-2 md:space-x-3 max-w-[85%] md:max-w-2xl"
            >
              <div class="w-8 h-8 md:w-10 md:h-10 bg-blue-100 rounded-full flex items-center justify-center flex-shrink-0">
              ...
              <div class="bg-white rounded-2xl px-3 py-2 md:px-4 md:py-3 shadow-md border border-gray-100">
                <p class="text-gray-800 leading-relaxed whitespace-pre-wrap text-sm md:text-base">{{ message.content }}</p>
      ...
      <button
        ...
        class="fixed bottom-24 right-4 bg-green-600 text-white rounded-full p-3 shadow-lg hover:bg-green-700 transition-all z-30"
      >
      ...
      <!-- Zone de Saisie -->
      <div class="bg-white border-t border-gray-200 p-4 md:p-6 flex-shrink-0" ref="inputArea">
          ...
          <div class="flex items-end space-x-2 md:space-x-4">
            <div class="flex-1">
              <textarea
                ...
                rows="1"
                class="w-full px-3 py-2 md:px-4 md:py-3 border border-gray-300 rounded-lg resize-none focus:ring-2 focus:ring-green-500 focus:border-transparent outline-none text-gray-800 placeholder-gray-500 text-sm md:text-base"
                :disabled="isLoading"
                ref="messageInput"
            ...
            <button
              ...
              class="bg-green-600 hover:bg-green-700 disabled:bg-gray-400 disabled:cursor-not-allowed text-white px-4 py-2 md:px-6 md:py-3 rounded-lg transition-all duration-200 flex items-center space-x-2 shadow-md hover:shadow-lg text-sm md:text-base"
            >
...
const sendMessage = async (messageText = newMessage.value.trim()) => {
  ...
  try {
    ...
    if (error.data?.detail) {
      ...
      errorMessage = 'Erreur interne du chatbot, réessayez plus tard.';
    }
