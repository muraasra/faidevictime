...
useHead({
  ...
  meta: [
    ...
    { name: 'twitter:title', content: 'SafePlace - Assistance aux Victimes | Soutien et Protection' },
    { name: 'twitter:description', content: 'SafePlace est une plateforme d\'assistance aux victimes offrant un soutien confidentiel, des conseils juridiques et un accompagnement personnalisé pour les personnes en situation de détresse.' },
